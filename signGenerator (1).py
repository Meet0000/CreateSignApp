...
class CreateMySignApp:
    ...
    def createCanvas(self):
        self.canvas = tkinter.Canvas(self.window, width=650, height=400, borderwidth=2, relief="solid")
    ...
    def createInput(self):
        ...
        input_label.place(x=570, y=550)
        self.input_box = tkinter.Entry(self.window, width=15)
        self.input_box.place(x=570, y=590)
    ...
    def createFontDropdown(self):
        ...
        font_dropdown_label.place(x=690, y=550)
    ...
    def createFontSizeDropDown(self):
        ...
        font_size_dropdown_menu.place(x=690, y=650)
    ...
    def login(self):
        ...
        if sha256(password.encode('utf-8')).hexdigest() == user["password"]:
            ...
            self.greeting_label.place(x=680, y=60)
    ...
    def onDownloadClick(self):
        try:
            x = self.canvas.winfo_rootx() + 0
            y = self.canvas.winfo_rooty() + 0
            x1 = x + 660
            y1 = y + 410
